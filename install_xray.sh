...
download_xray() {
    DOWNLOAD_LINK="https://github.com/XTLS/Xray-core/releases/download/$XRAY_VERSION/Xray-linux-$ARCH.zip"
...
place_xray() {
    ...
    curl -Lo /usr/local/share/xray/iran.dat https://github.com/bootmortis/iran-hosted-domains/releases/download/$DOMAIN_VERSION/iran.dat
